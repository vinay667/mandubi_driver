...
class MyRidesTab2 extends StatefulWidget {
  MyRidesTab2State createState() => MyRidesTab2State();
}

class MyRidesTab2State extends State<MyRidesTab2>{
  @override
                        ...
                        child: Row(
                          children: <Widget>[
                            Padding(
                              ...
                              child: Image.asset('images/check_green.png',width: 32,height: 32,),
                            ),
