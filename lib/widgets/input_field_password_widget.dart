...
class InputBoxPasswordWidget extends StatelessWidget {
  FocusNode focusNode;
  ...
  InputBoxPasswordWidget({this.focusNode, this.onTapTrigger, this.labelText,this.isObscureText,this.controller,this.validator,this.isEnabled,this.passwordIC});
          ...
          Align(
            ...
            child: GestureDetector(
              ...
              child: Container(
                width: 22,
                height: 22,
                margin: EdgeInsets.only(right: 25,top: 16.5),
                child: Image.asset('images/pwd_ic.png'),
              ),
            )
          )
