...
class InputBoxWidgetMulti extends StatelessWidget {
  FocusNode focusNode;
  ...
  InputBoxWidgetMulti({this.focusNode, this.onTapTrigger, this.labelText,this.isObscureText,this.controller,this.validator,this.isEnabled});
